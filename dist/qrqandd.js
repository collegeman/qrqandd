...
var index = (0,vue__WEBPACK_IMPORTED_MODULE_0__.defineComponent)({
    ...
    methods: {
        ...
        generate() {
            ...
            switch (this.tag) {
                case 'canvas':
                    (0,qrcode__WEBPACK_IMPORTED_MODULE_1__.toCanvas)(this.$el, value, options, (error) => {
                        if (error) {
                            throw error;
                        }
                        done();
                    ...
                    break;
                case 'img':
                    (0,qrcode__WEBPACK_IMPORTED_MODULE_1__.toDataURL)(value, options, (error, url) => {
                        if (error) {
                            throw error;
                        }
                        this.$el.src = url;
                    ...
                    break;
                case 'svg':
                    (0,qrcode__WEBPACK_IMPORTED_MODULE_1__.toString)(value, options, (error, string) => {
                        if (error) {
                            throw error;
                        }
...
/* harmony import */ var _chenfengyuan_vue_qrcode__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @chenfengyuan/vue-qrcode */ "./node_modules/@chenfengyuan/vue-qrcode/dist/vue-qrcode.esm.js");
